...
namespace Ogresoft
{
    ...
    public class Diagnostics
    {
        ...
        /// <summary>
        /// Trace listener that simply fires an event.
        /// </summary>
        public class DlsTraceListener : TraceListener  
        {
            /// <summary>
            /// Begins listening to the trace output. 
            /// </summary>
            public DlsTraceListener()
            {
            ...
            /// </summary>
            public class DlsTraceListenerEventArgs : EventArgs
            {
                /// <summary>
                /// Constructor. 
                /// </summary>
                /// <param name="message"></param>
                public DlsTraceListenerEventArgs(string message)
                {
                    Message = message;
                }
            ...
            /// </summary>
            public event EventHandler<DlsTraceListenerEventArgs> Traced;

            /// <summary>
            /// Fires the Traced event. 
            /// </summary>
            /// <param name="message"></param>
            public void OnTraced(string message)
            {
                EventHandler<DlsTraceListenerEventArgs> handler = Traced;

                if (handler != null)
                    handler(null, new DlsTraceListenerEventArgs(message));
            }
        ...
        /// <summary>
        /// A <see cref="TraceExListener"/> component to write 
        /// <see cref="TraceEx"/> messages to the local machine 
        /// application event log.
        /// </summary>
        /// <remarks>
        /// This component is meant to mimic the 
        /// <see cref="EventLogTraceListener"/> component.
        /// </remarks>
        public class EventLogWriter
        {
            public EventLogWriter(string sourceName, string logName)
            {
                ...
                _log.WriteEntry("log opened");
            }

            private EventLog _log;

            /// <summary>
            /// Writes the message to the event log and flags it as information. 
            /// </summary>
            /// <param name="message"></param>
            ...
            /// <summary>
            /// Writes a message to the event log and flags it as an error. 
            /// </summary>
            /// <param name="message"></param>
            public void WriteWarning(string message)
            {
                ...
                // This exception is thrown when the event log is full. 
                catch (System.ComponentModel.Win32Exception ex)
                {
                    Debug.WriteLine(ex);
                    Debug.WriteLine("The eventlog cannot be written to.");
                    //System.Windows.Forms.Application.Exit();
                }

                // I have not observed this exception. 
                catch (Exception ex)
                {
                    Debug.Assert(false);
                    Debug.WriteLine(ex);
            ...
            public void WriteException(string message)
            {
                ...
                {
                    string exceptionInfo = GetVerboseExceptionInfo(ex);
                    Debug.WriteLine(ex);
                    Debug.WriteLine(exceptionInfo); 
                    Debug.WriteLine("The eventlog cannot be written to. Insufficient privileges to write to the Event Log.");
                    Debug.WriteLine("The original exception was: " + message); 
                    System.Windows.Forms.Application.Exit();
                }
                // I have not observed this exception. 
                catch (Exception ex)
